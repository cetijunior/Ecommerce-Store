...
const ProductPage = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            <Navbar />
            <div className="max-w-7xl mx-auto mt-12 px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        {product && (
                            <>
                                ...
                                <div className="space-y-2 mt-4 text-gray-800">
                                    <span className='font-bold text-2xl text-black'> Description: </span>
                                    <p className='text-xl'>{product.description}</p>
                                </div>
                                <div className="flex flex-row space-x-4 items-center mt-2 text-lg text-gray-700">
